...
(function () {
  ...
  const RACE_META = {
    ...
    kitakyushu2026: { short: "北九州記念", en: "KITAKYUSHU KINEN", emoji: "⚡", grade: "G3" },
    tanabata2026: { short: "七夕賞", en: "TANABATA SHO", emoji: "🎋", grade: "G3" },
  };
  ...
  const VERDICTS = {
    ...
    kitakyushu2026:
      "小倉芝1200は芝良・傷み軽く、先行力と内枠の器用な立ち回りが重要。◎デアヴェローチェ(3歳牝馬53kg×葵S勝ち×先行)を軸に。1番人気フリッカージャブは57.5kg酷量＋外枠で危険馬に評価を下げ、代わりに50kg最軽量×前走2勝勝ちの ○ジェニファー(8番人気)を妙味の対抗に抜擢。▲ランフォーヴァウ(1枠先行)・△アメリカンビキニ(51kg逃げ)まで。⚠フリッカージャブ・差し脚質で展開待ちの ⚠アンクルクロス(3番人気)は人気でも過信禁物とし、軽ハンデ先行勢の一発を狙う。",
    tanabata2026:
      "JRA-VANデータの核心「斤量今回減×前走4角2〜7番手×距離変化」を満たすのは3頭のみ。うち七夕賞出走歴のある馬を除くと ◎センツブラッド・○コントラポスト の2頭に絞られ、ともにルーラーシップ産駒で稍重の道悪に最適。当日の福島3R(同じ芝2000m稍重)は中団から動いた馬が1-2着・逃げ馬は3着どまりで、この2頭の脚質と完全に合致する。▲サヴォーナ(福島民報杯1着)・△マイネルモーント(ゴールドシップの道悪◎)まで。人気上位は総崩れ想定で、⚠カラマティアノス(1番人気・斤量増減なしの不振ゾーン)、⚠アスクナイスショー・⚠バトルボーン(ともに前走4角1番手【0-0-0-3】＋逃げ不利馬場)を軒並み危険馬に。波乱必至。",
  ...
  const STRATEGY_NOTES = {
    ...
    kitakyushu2026: {
      axis: "3歳牝馬53kgの斤量利×葵S勝ち×先行。小倉芝1200の先行有利馬場に完全合致",
      counter: "50kg最軽量×前走宗像特別(2勝)完勝×内枠2番先行。8番人気の妙味",
      hole: "1枠先行×谷川岳S勝ちの勢い。ロスなく好位を取れる",
      bighole: "51kg軽量×逃げ。ハイペースに持ち込めば残り目",
    },
    tanabata2026: {
      axis: "斤量減×前走4角2番手×距離延長のデータ完全合致。ルーラーシップの道悪血統",
      counter: "同じくデータ完全合致。中山ディセンバーS(重)5着の道悪実績と重賞好走歴",
      hole: "前走福島民報杯1着の福島2000m巧者。58kgとデータ×が割引材料",
      bighole: "データ3条件を満たす16番人気。減点は七夕賞出走歴のみ",
    },
  };
  ...
  loadRace("kitakyushu2026.json", "kitakyushu2026");
  loadRace("tanabata2026.json", "tanabata2026");
